...
const CATALOGUE = {
  es: {
    ...
    'eficiencia.pares.titulo': 'Frente a municipios comparables',
    ...
    'eficiencia.lectura.titulo': 'Lectura rápida',
    'eficiencia.lectura.servicios': 'servicios con coste unitario',
    'eficiencia.lectura.particion': 'por debajo · por encima de su mediana',
    'eficiencia.lectura.particionConMediana': 'por debajo · por encima · en su mediana',
    'eficiencia.lectura.congelados': 'denominadores sin remedir',
    'eficiencia.lectura.sinRendir': 'entrega sin rendir',
    'eficiencia.lectura.bloqueados': 'sin cociente posible',
    'eficiencia.lectura.hallazgo': 'hallazgo firmado',
    'eficiencia.lectura.hallazgos': 'hallazgos firmados',
    'eficiencia.subnav.aria': 'Secciones de la página',
    'eficiencia.subnav.lectura': 'Lectura',
    'eficiencia.subnav.cobertura': 'Cobertura',
    'eficiencia.subnav.posiciones': 'Posiciones',
  ...
  ca: {
    ...
    'eficiencia.pares.titulo': 'Enfront de municipis comparables',
    ...
    'eficiencia.lectura.titulo': 'Lectura ràpida',
    'eficiencia.lectura.servicios': 'serveis amb cost unitari',
    'eficiencia.lectura.particion': 'per davall · per damunt de la seua mediana',
    'eficiencia.lectura.particionConMediana': 'per davall · per damunt · en la seua mediana',
    'eficiencia.lectura.congelados': 'denominadors sense tornar a mesurar',
    'eficiencia.lectura.sinRendir': 'entrega sense retre',
    'eficiencia.lectura.bloqueados': 'sense quocient possible',
    'eficiencia.lectura.hallazgo': 'troballa signada',
    'eficiencia.lectura.hallazgos': 'troballes signades',
    'eficiencia.subnav.aria': 'Seccions de la pàgina',
    'eficiencia.subnav.lectura': 'Lectura',
    'eficiencia.subnav.cobertura': 'Cobertura',
    'eficiencia.subnav.posiciones': 'Posicions',
