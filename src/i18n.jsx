...
export const CATALOGUE = {
  es: {
    ...
    'nav.grupo.vigilancia.lede': 'lo que cambia y lo que se comprueba',
    'nav.grupo.ciudadania': 'Ciudadanía',
    'nav.grupo.ciudadania.lede': 'lo que puedes hacer y consultar',
    'nav.grupo.laboratorio': 'Laboratorio',
    'nav.grupo.laboratorio.lede': 'datos abiertos y experimentos, con su método',
    ...
    'nav.desc.eficiencia': 'Coste unitario de los servicios, frente a municipios parecidos',
    'nav.desc.gestion': 'Plazos de pago, competencia en contratos y ejecución',
    ...
    'nav.desc.declaraciones': 'Cada afirmación de pleno, cotejada con datos abiertos',
    ...
    'nav.desc.frontera': 'Análisis envolvente del gasto, y lo que no mide',
  ...
  ca: {
    ...
    'nav.grupo.vigilancia.lede': 'el que canvia i el que es comprova',
    'nav.grupo.ciudadania': 'Ciutadania',
    'nav.grupo.ciudadania.lede': 'el que pots fer i consultar',
    'nav.grupo.laboratorio': 'Laboratori',
    'nav.grupo.laboratorio.lede': 'dades obertes i experiments, amb el seu mètode',
    'nav.grupo.proyecto': 'Sobre CivicPulse',
    ...
    'nav.desc.eficiencia': 'Cost unitari dels serveis, davant de municipis semblants',
    'nav.desc.gestion': 'Terminis de pagament, competència en contractes i execució',
    ...
    'nav.desc.declaraciones': 'Cada afirmació del ple, acarada amb dades obertes',
    'nav.desc.datos': 'Tot el que alimenta el lloc, descarregable',
    ...
    'nav.desc.laboratorio': 'Afirmacions de premsa davant de les dades públiques',
    'nav.desc.frontera': 'Anàlisi envolupant de la despesa, i el que no mesura',
