...
export const CATALOGUE = {
  es: {
    ...
    'quejas.detalle.reloj.dias': '{n} días',
    ...
    'quejas.detalle.hito.verificada.detalle': '{n} apoyos vecinales · incluida en el lote semanal',
    'quejas.detalle.hito.registrada': 'Registrada en sede electrónica',
    'quejas.detalle.hito.registrada.detalle':
      'Asiento {asiento} · inicio del reloj legal ({n} días)',
  ...
  ca: {
    ...
    'quejas.detalle.reloj.dias': '{n} dies',
    ...
    'quejas.detalle.hito.verificada.detalle': '{n} suports veïnals · inclosa en el lot setmanal',
    'quejas.detalle.hito.registrada': 'Registrada en la seu electrònica',
    'quejas.detalle.hito.registrada.detalle':
      'Assentament {asiento} · inici del rellotge legal ({n} dies)',
