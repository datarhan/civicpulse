...
6,304 of Spain's 8,131 municipalities — 77.53% of them — are news deserts, home to 11.6 million people ([Negreira-Rey, Vázquez-Herrero & López-García, _Media and Communication_ 11(3), 2023](https://doi.org/10.17645/mac.v11i3.6727)). Not "declining" coverage — none. No reporter sits through the council session, reads the contract register, or checks whether the thing a party promised at election time ever happened. The data to hold these town halls to account is almost all public and open — budgets, contracts, subsidies, the census, the official gazettes — but nobody turns it into anything a resident would actually read.
