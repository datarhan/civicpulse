...
# claude pasó al llavero, y desde el 23-sep no corre a diario sino lunes y jueves a las 09:30.
...
if [ "${1:-install}" != "uninstall" ]; then
  echo "[cron-install] retirado: hallazgos lo programa launchd (lunes y jueves a las 09:30)." >&2
