...
**You cannot see who is running it, or how the law checks them.** A resident can rarely find out what the person holding a portfolio brings to it, what the post pays, or who is meant to be watching — all of it public, all of it scattered. Nor that Spanish law checks the two tiers of a town hall in deliberately different ways. The officers who audit the money and certify decisions are checked **technically**: **RD 128/2018 (arts. 17–19)** requires a university degree and a national competitive examination. Elected members are checked **electorally**: under **LOREG art. 6.1** a councillor needs only to be of age, on the electoral roll and not disqualified — no qualification of any kind, and that is by design, not by oversight.
...
> **What this project does not do.** It does not attribute motive: it never says who was appointed for the wrong reasons, who is in it for an easy salary, or what anyone is hiding. And **it does not score** — not the council, not a service, not an officeholder, not another municipality. That second refusal is measured, not squeamish: four equally defensible indicator baskets move the efficiency figure across half the scale, so a score would describe our modelling choices more than the town. The method ships, failed specifications included; the table does not. What is published is what can be checked — what each office-holder declared, what the law requires of the post, what it pays, what was promised and what the record shows — and the conclusion is the reader's, drawn at the ballot box. That restraint is not timidity; it is the only version of this that holds up.
