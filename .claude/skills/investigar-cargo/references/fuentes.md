...
| BOP València                                           | candidaturas de la Junta Electoral de Zona de Llíria, todas localizadas (lista abajo), declaraciones, nombramientos, edictos que nombran personas | `https://bop.dival.es/bop/downloads?boletinFecha=DD/MM/YYYY` (boletín entero); `npx tsx scripts/buscar-bop-historico.ts --desde --hasta --busca` (sin alias npm); búsqueda por palabra sólo en Chrome (JS) | la búsqueda es una app Java con sesión                                                                                                                                      | `official-doc`                                                 |
...
- **Candidaturas municipales de Riba-roja (Junta Electoral de Zona de Llíria), localizadas el 19-09-2026.**
  2003: anuncio 2003/09438 (29-04-2003, supl. 100-02) · 2007: anuncio 2007/11329 (01-05-2007, supl. 102-02) ·
  2011: boletín entero de 26-04-2011 (glifos desplazados: `--texto`) · 2015: boletín entero de 28-04-2015 (n.º 79) ·
  2019: boletín entero de 30-04-2019 (n.º 82) · 2023: anuncio 2023/05884 (02-05-2023, n.º 83 supl. 1). Las de 2003,
  2007 y 2023 van en un SUPLEMENTO que `downloads?boletinFecha=` no sirve (el boletín ordinario de 01-05-2007 tiene
  12 páginas y ni una candidatura): se encuentran por título en el buscador JSF («candidaturas», sin sección) y se
  bajan con `downloads?anuncioNumReg=`. El buscador no devuelve nada anterior a ~2000.
- **Un anuncio a dos columnas engaña a `pdftotext -layout`.** El 19-09-2026 el nombramiento de personal eventual de
  la Diputació (anuncio 2011/27488) dejó el nombre de un asesor del Grupo Socialista en la MISMA línea que «JEFE
  PROTOCOLO GABINETE PRESIDENCIA», que es de la columna de al lado. Antes de creerse un emparejamiento, lee el anuncio
  entero y busca una republicación a una columna (la hubo: 2011/34704). Al revés pasa con los CV del portal: el
  extracto PLANO pega el título de una entrada a la descripción de la anterior («Matriculación en magisterio EGB»
  eran dos entradas); los CV se leen con `-layout`.
